...
def parse_config() -> argparse.Namespace:
    ...
    conf_parser.add_argument("-c", "--conf_file", help="Specify config file")
    ...
    parser.add_argument('--dataset_dir',                help='Dataset directory',
                        default='/home/srossi/research/datasets',)
    ...
    parser.add_argument('--iterations',                 help='Total training iterations', default=1000,)
    parser.add_argument('--device',                     help='Device backend', default='cpu',)
    parser.add_argument('--test_interval',              help='Test every given iterations', default=1000,)
...
def run_experiment(name, outdir, seed, fold, dataset, dataset_dir, batch_size, svi, bias, approx,
                   local_reparameterization, nmc_train, nmc_test, lr, iterations, device, test_interval,
                   test_verbose, train_verbose, logger, logdir):
