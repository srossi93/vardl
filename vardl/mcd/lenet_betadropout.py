...
from ..layers import BetaDropout

class LeNetBeta_MNIST(nn.Module):

    def __init__(self, nmc_test):
        super(LeNetBeta_MNIST, self).__init__()


        self.conv1 = nn.Conv2d(1, 20, kernel_size=5, padding=0, bias=None)
        self.dropout = BetaDropout(0.1, 0.1)
...
class LeNetBeta_CIFAR10(nn.Module):

    def __init__(self, nmc_test):
        super(LeNetBeta_CIFAR10, self).__init__()
